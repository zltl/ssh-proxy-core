...
static int test_upstream_error_enum_values(void) {
    ...
    ASSERT_NE((int)UPSTREAM_ERR_CIRCUIT_OPEN, 0);
    ASSERT_NE((int)UPSTREAM_ERR_CHANNEL_OPEN, 0);
    ASSERT_NE((int)UPSTREAM_ERR_CHANNEL_REQUEST, 0);
    ...
    ASSERT_NE((int)UPSTREAM_ERR_POLICY_DENIED, (int)UPSTREAM_ERR_CIRCUIT_OPEN);
    ASSERT_NE((int)UPSTREAM_ERR_CHANNEL_OPEN, (int)UPSTREAM_ERR_CHANNEL_REQUEST);
    return 0;
}
